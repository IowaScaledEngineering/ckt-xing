...
#define INPUT_ISLAND_OCC      0x02
#define INPUT_EAST_APPR_OCC   0x04
#define INPUT_XING_CANCEL     0x08
...
void initializeCrossingTrack(CrossingTrack_t* t, uint16_t timeApproachTimeout, uint8_t timeIslandTimeout);
